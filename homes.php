                ...
                <div class="container">
                    <div class="row">
                        <div class="main_home text-center">
                            <div class="home_text">
                                <h4 class="text-white text-uppercase">21st century multidimensional company</h4>
                                <h1 class="text-white text-uppercase">kamano homes</h1>

                                <div class="separator"></div>

                                <h5 class=" text-uppercase text-white"><em>Is driven to secure suitable, affordable housing for our clients, irrespective of their income level. We promise to expand our clientbase and offering the best excellent services and quality housing products with the singular mission to exceed expectation.</em></h5>
                            </div>
                        </div>
                    </div><!--End off row-->
                        ...
                        <div class="main-gallery roomy-80">
                            <div class="col-md-12">
                                <div class="head_title text-left sm-text-center wow fadeInDown">
                                    <h2>Houses</h2>
                                    <h5><em>Discover houses and homes here</em></h5>
